...
Put one complete public audit sentence beginning exactly `Public audit:` in
`deliberation`. State the decisive reason: the new capability, duplication,
semantic risk, unclear boundary, or entry-cost problem.
