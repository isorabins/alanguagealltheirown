...
Produce the smallest coherent edition that preserves everything useful and
operative in the current language. The resulting rulebook should be easier for
...
Return the consolidated groups, assignments, exclusions, and three creative
seeds using only the supplied schema.
