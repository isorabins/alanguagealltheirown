...
- Encode returns a journey id plus adopted-language version/hash; decode refetches canonical state and returns contract-shaped `409 rulebook_changed` before a model call on mismatch.
