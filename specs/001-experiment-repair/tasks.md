...
- [X] T209 Implement only the deterministic legislative prompt change in `loop.py`; update mechanism/contract wording without changing model, routing, schema, validator, retries, temperature, cadence, canonical state/history, UI, DNS, credentials, or X (FR-075, FR-076, FR-077; SC-037)
